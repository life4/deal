...
def test_stdin():
    ...
    expected = [
        (6, 4, 'DEAL001: post contract error', Checker),
        (11, 4, 'DEAL002: raises contract error (ZeroDivisionError)', Checker),
        (13, 4, 'DEAL002: raises contract error (KeyError)', Checker),
    ]
